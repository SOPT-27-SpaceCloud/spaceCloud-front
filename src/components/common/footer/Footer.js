...
import footerLine from '../../../assets/images/footer/line_horizontal.svg';
//import lineVertical from '../../../assets/images/footer/line_vertical.svg';
        ...
        <>
            <div className = "footer">
                <div className = "footer_top">
                    ...
                    <img className="footer_top_line" alt="line" src={footerLine}/>
